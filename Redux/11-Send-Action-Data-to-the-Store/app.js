...
// This case should be triggered whenever there is an action of type ADD_NOTE and
// it should return the text property on the incoming action as the new state.
