...
// This is a standard pattern in writing Redux reducers. The switch statement should
// switch over action.type and return the appropriate authentication state.
...
// even when the action isn't related to that reducer. In such a case, you want to make sure
// that you return the current state.
// SOLUTION:
const defaultState = {
  authenticated: false,
};
